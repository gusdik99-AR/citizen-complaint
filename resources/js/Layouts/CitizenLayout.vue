  ...
  <div class="min-h-screen bg-gray-50">
    ...
    <header class="bg-white shadow-sm sticky top-0 z-30">
      <div class="px-4 py-3">
        ...
        <div class="flex items-center justify-between mb-2">
          <div class="flex items-center gap-2">
            <img src="/logo-pemalang.png" alt="Logo" class="h-8 w-8" onerror="this.style.display='none'">
            <div>
      ...
      <div v-if="mobileMenuOpen" class="border-t border-gray-200 bg-white">
        <nav class="px-4 py-3 space-y-2">
          <a href="/" class="block px-4 py-2 text-sm text-gray-700 hover:bg-yellow-50 hover:text-yellow-700 rounded-lg transition">
    ...
    <nav class="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 z-30 sm:hidden">
      <div class="grid grid-cols-4 gap-1 px-2 py-2">
        <a href="/" class="flex flex-col items-center justify-center py-2 px-1 text-yellow-600">
          <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
          </svg>
          <span class="text-xs font-medium mt-1">Beranda</span>
        </a>
        <a href="#" class="flex flex-col items-center justify-center py-2 px-1 text-gray-500 hover:text-yellow-600">
          <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
          </svg>
